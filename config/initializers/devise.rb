...
# Many of these configuration options can be set straight in your
# model.
Devise.setup do |config|
  # The secret key used by Devise. Devise uses this key to generate
  # random tokens. Changing this key will render invalid all existing
  # confirmation, reset password and unlock tokens in the database.
  # Devise will use the `secret_key_base` as its `secret_key` by
  # default. You can change it below and use your own secret key.
  # config.secret_key = '...'
  ...
  # also supply a hash where the value is a boolean determining
  ...
  # without confirming their account. For instance, if set to 2.days,
  # the user will be able to access the website for two days without
  ...
  # user can confirm their account within 3 days after the mail was
  # sent, but on the fourth day their account can't be confirmed with
  # the token any more.  Default is nil, meaning there is no
  # restriction on how long a user can take before confirming their
  # account.
  ...
  config.rememberable_options = Rails.application.config.devise_rememberable_opt
  ...
  # The time you want to timeout the user session without
  # activity. After this time the user will be asked for credentials
  # again. Default is 30 minutes.
