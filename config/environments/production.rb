Rails.application.configure do
  ...
  # Force devise to use secure cookies.
  config.devise_rememberable_opt = { secure: true }
  ...
  # config.active_job.queue_name_prefix = "baplan_#{Rails.env}"
